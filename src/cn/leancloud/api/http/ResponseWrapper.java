...
public class ResponseWrapper {
    private static final Logger LOG = Logger.getLogger(ResponseWrapper.class.toString());
    ...
    public void setRateLimit(String quota, String remaining, String reset) {
        ...
        try {
            ...
            LOG.debug("API Rate Limiting params - quota:" + quota + ", remaining:" + remaining + ", reset:" + reset);
